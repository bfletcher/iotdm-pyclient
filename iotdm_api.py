...
class Iotdm_api():
	...
	def create(self, URI, resource_type, payload, origin=None, requestID=None):
		...
		self.agent.request(self.protocol, "post", URI, payload=payload, ty=resource_type, origin=origin, requestID=requestID)
	...
	def retrieve(self, URI, origin=None, requestID=None):
		...
		self.agent.request(self.protocol, "get", URI, origin=origin, requestID=requestID)
	...
	def update(self, URI, payload, origin=None, requestID=None):
		...
		self.agent.request(self.protocol, "put", URI, payload=payload, origin=origin, requestID=requestID)
	...
	def delete(self, URI, origin=None, requestID=None):
		...
		self.agent.request(self.protocol, "delete", URI, origin=origin, requestID=requestID)
